...
GLOBAL vu32 adc_value;
GLOBAL vu8 ADCflag ;
GLOBAL __IO  vu32 TimingDelay;
GLOBAL __IO    vu32 CRCValue;
GLOBAL vu16 ADCVAL;
GLOBAL vu16 ADC_flag;
GLOBAL float fValue;
GLOBAL vu16 ADCValue[20];
GLOBAL float ADCVolatge[3];
GLOBAL vu16 ADCFilterValue[3];

GLOBAL vu8 ADCTrigFilterflag;
#define AVERAGELEN                   20
GLOBAL vu16 varADCavarage[AVERAGELEN][3];
