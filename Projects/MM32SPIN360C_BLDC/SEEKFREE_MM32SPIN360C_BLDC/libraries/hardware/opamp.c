...
void opamp_init(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin  =  GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_11 | GPIO_Pin_12;	//Ia Ic inverse and non inverse input
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AIN;           //运放所使用的引脚需要设置为模拟输入
	GPIO_Init(GPIOB, &GPIO_InitStructure);
    
    GPIO_InitStructure.GPIO_Pin  =  GPIO_Pin_4 | GPIO_Pin_5; 	//A4 Isum A5 inverse input 
