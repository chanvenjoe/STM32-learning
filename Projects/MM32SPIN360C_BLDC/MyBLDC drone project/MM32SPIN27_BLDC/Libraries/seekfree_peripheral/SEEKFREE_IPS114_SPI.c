...
void ips114_init(void)
{
	...
	gpio_init(IPS114_CS_PIN, GPO, GPIO_HIGH, GPO_PUSH_PUL);
	gpio_init(IPS114_DC_PIN, GPO, GPIO_LOW, GPO_PUSH_PUL);
	gpio_init(IPS114_REST_PIN, GPO, GPIO_LOW, GPO_PUSH_PUL);
	gpio_init(IPS114_BL_PIN, GPO, GPIO_HIGH, GPO_PUSH_PUL);
