...
#define BRAKE		HAL_TIM_PWM_Stop(&htim1, TIM_CHANNEL_1);  HAL_GPIO_WritePin(MOSL, AL, GPIO_PIN_SET); HAL_GPIO_WritePin(MOSL, BL, GPIO_PIN_SET)
#define BRKRLS		HAL_GPIO_WritePin(MOSL, AL, GPIO_PIN_RESET);
#define CLOSE_PWM 	HAL_TIM_PWM_Stop(&htim1, TIM_CHANNEL_1)//; HAL_GPIO_WritePin(MOSL, AL|BL|CL, GPIO_PIN_RESET)
